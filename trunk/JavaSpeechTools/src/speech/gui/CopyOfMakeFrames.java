...
public class CopyOfMakeFrames {
	...
	public CopyOfMakeFrames(boolean isApplet, int phonemes, int onscreenBins) {
	...
	public void updateGfx(double[][][] vocalTract1, String text,
			double[][][] innerLips, double[][][] outerLips,
			double[] neuralOutputs, double[] magn) {

		drawTract.vectorMean(vocalTract1, neuralOutputs, text);
		...
		drawTargTract.vectorMean(vocalTract1, KeyHandler.targetNeuralOutputs, KeyHandler.text);
